...
for epoch in range(epochs):
    ...
    for x_batch, y_batch in train_loader:
        ...
        y_predict = model_sigmoid(x_batch)
...
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.title('Training Accuracy vs Epochs with Sigmoid')
plt.legend()
plt.show()
...
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.title('Test Accuracy vs Epochs with Sigmoid')
plt.legend()
plt.show()
...
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.title('Training Loss vs Epochs with Sigmoid')
plt.legend()
plt.show()
...
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.title('Test Loss vs Epochs with Sigmoid')
plt.legend()
plt.show()